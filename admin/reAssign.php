...
require('../fun.php');
if(sessioncheck() == true or isset($_POST['re']))
{
$con = connect(); 
$hid=$_POST['re'];
...
$pass=$r2['password'];
    ...
    $q6=mysqli_query($con,"UPDATE tbl_hostel_reg SET `status`=1 WHERE `hstl_id`=$hid")or die("Sign in Error q3");
    
    require '../mail/vendor/autoload.php';
    $message = "<p>Hey,". $hm  ."<br>Your accout is Re-Activated</p>";
